...
import (
	...
	"github.com/juanmalvarez3/twit/internal/domains/twitter/follow/repository"
...
func Provide() Service {
	...
	publisher := sns.NewFollowSNSPublisher(snsClient, cfg, logs)

	return New(repo, publisher, logs)
}
